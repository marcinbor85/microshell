...
void test_ush_utils_get_status_string(void)
{
        ...
        TEST_ASSERT_EQUAL_STRING(USH_CONFIG_TRANSLATION_ERROR ": " USH_CONFIG_TRANSLATION_FILE_NOT_WRITABLE, ush_utils_get_status_string(USH_STATUS_ERROR_FILE_NOT_WRITABLE));
        TEST_ASSERT_EQUAL_STRING(USH_CONFIG_TRANSLATION_ERROR ": " USH_CONFIG_TRANSLATION_FILE_NOT_READABLE, ush_utils_get_status_string(USH_STATUS_ERROR_FILE_NOT_READABLE));
